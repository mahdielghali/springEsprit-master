...
public class DepartementController {
    ...
    @GetMapping("/retrieveDepartementsByUniversite/{idUniversity}")
    public List<Departement> retrieveDepartementsByUniversite(@PathVariable("idUniversity") long idUniversite){
